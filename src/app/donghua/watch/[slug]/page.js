...
export default function WatchDonghuaPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await fetch(`https://anyapi-beta.vercel.app/v1/donghua/anichin/episode/${slug}`, {
          headers: {
            "X-API-Key": apiKey,
          },
          cache: "no-store",
  ...
  if (!episodeInfo) {
    return (
      <div className="min-h-screen flex items-center justify-center p-4 bg-[#0f1729]">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-yellow-500 mb-2">Episode Tidak Ditemukan</h2>
          <p className="text-gray-300 mb-4">Maaf, episode yang Anda cari tidak tersedia.</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-[#121a2e] rounded-lg p-4 mb-6 border border-gray-800">
              <h3 className="text-lg font-semibold text-white mb-3">Pilih Server</h3>
              ...
              <div className="md:hidden">
                <select 
                  ...
                  onChange={(e) => {
                    ...
                    setSelectedServer(episodeInfo.streaming.servers[selectedServerIndex]);
                  }}
                  value={episodeInfo.streaming.servers.findIndex(server => 
            ...
            {/* Download Links */}
            {episodeInfo.download_url && Object.keys(episodeInfo.download_url).length > 0 && (
              <div className="bg-[#121a2e] rounded-lg p-4 mb-6 border border-gray-800">
                <h3 className="text-lg font-semibold text-white mb-3">Download</h3>
                
                {/* Kualitas */}
                <div className="mb-4">
                  <h4 className="text-sm font-medium text-gray-400 mb-2">Kualitas:</h4>
                ...
                {downloadUrls && (
                  <div>
                    <h4 className="text-sm font-medium text-gray-400 mb-2">Link Download:</h4>
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                      {Object.entries(downloadUrls).map(([provider, url], index) => (
                        <a
                          key={index}
                          href={url}
                          target="_blank"
          ...
          <div className="lg:col-span-1">
            ...
            {/* Navigasi Episode */}
            <div className="bg-[#121a2e] rounded-lg p-4 mb-6 border border-gray-800">
              <h3 className="text-lg font-semibold text-white mb-3">Navigasi Episode</h3>
            ...
            {/* Daftar Episode */}
            <div className="bg-[#121a2e] rounded-lg p-4 mb-6 border border-gray-800">
              <h3 className="text-lg font-semibold text-white mb-3">Daftar Episode</h3>
              ...
              <div className="max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
                <div className="flex flex-col gap-2">
                  {getFilteredAndSortedEpisodes(episodeInfo.episodes_list).map((ep, index) => (
                    <button
                      key={index}
              ...
              {getFilteredEpisodes(episodeInfo.episodes_list).length === 0 && (
                <div className="bg-gray-800/30 rounded-lg p-4 text-center mt-3">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Coba gunakan kata kunci pencarian yang berbeda</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-[#121a2e] rounded-lg p-4 mb-6 border border-gray-800">
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {[...Array(4)].map((_, index) => (
                    <div key={index} className="h-8 w-16 bg-gray-700 rounded animate-pulse"></div>
                  ))}
                </div>
              </div>
